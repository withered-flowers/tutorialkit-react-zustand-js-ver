...
Setelah membuat store, kita dapat menggunakan store yang telah kita buat di dalam komponen kita untuk:
- Membaca state
- Memanggil action untuk mengubah state

Pada langkah selanjutnya kita akan mencoba untuk membaca state yang sudah dibuat untuk digunakan di dalam komponen kita.